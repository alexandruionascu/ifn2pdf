    ...
    describe('basic generator', () => {
        ...
        for (let i = 0; i < testCases.length; i += 1) {
            ...
            test(testName, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const [actualPdf, expectedPdf] = yield Promise.all([getPdf(tmpFile), getPdf(assertFile)]);
                // @ts-ignore
        ...
        for (let l = 0; l < entries.length; l += 1) {
            ...
            test(`snapshot ${key}`, () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                const pdf = yield (0, generate_1.default)({
                    inputs,
                    template,
                    plugins: Object.assign({ text: schemas_1.text, image: schemas_1.image }, schemas_1.barcodes),
                    options: { font },
                });
...
Check this document: https://pdfme.com/docs/custom-fonts`);
    ...
    test(`check digit error`, () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        try {
            yield (0, generate_1.default)({ inputs, template, plugins: Object.assign({}, schemas_1.barcodes) });
        }
        catch (e) {
            fail();
        }
