...
var _default = exports.default = function _default(props) {
  ...
  var _d = listProps || {},
    addBtnProps = _d.addBtnProps,
    delConfirmProps = _d.delConfirmProps,
    actionColumnProps = _d.actionColumnProps,
    hideAdd = _d.hideAdd,
    hideCopy = _d.hideCopy,
    hideMove = _d.hideMove,
    hideDelete = _d.hideDelete,
    onAdd = _d.onAdd,
    onRemove = _d.onRemove,
    onMove = _d.onMove,
    onCopy = _d.onCopy,
    otherListProps = (0, _tslib.__rest)(_d, ["addBtnProps", "delConfirmProps", "actionColumnProps", "hideAdd", "hideCopy", "hideMove", "hideDelete", "onAdd", "onRemove", "onMove", "onCopy"]);
  ...
  if (hideMove === undefined && ((_b = globalConfig === null || globalConfig === void 0 ? void 0 : globalConfig.listOperate) === null || _b === void 0 ? void 0 : _b.hideMove)) {
  ...
  var operateBtnType = (_c = globalConfig === null || globalConfig === void 0 ? void 0 : globalConfig.listOperate) === null || _c === void 0 ? void 0 : _c.btnType;
  var ruleList = [];
  if (!readOnly) {
    ruleList = [{
