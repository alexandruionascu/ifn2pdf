...
var TableList = function TableList(props) {
  ...
  var handleDrawerClose = function handleDrawerClose(data) {
    setVisible(false);
    setItemData(null);
    if (!data) {
      return;
    ...
    if (indexRef.current === -1) {
      ...
      form.setFieldValue([].concat(_toConsumableArray(rootPath), [indexRef.current]), data);
    }
    indexRef.current === null;
  };
  var columns = Object.keys(columnSchema).map(function (dataIndex) {
    var _columnSchema$dataInd = columnSchema[dataIndex],
      title = _columnSchema$dataInd.title,
      tooltip = _columnSchema$dataInd.tooltip,
      width = _columnSchema$dataInd.width;
    var tooltipProps = getTooltip(tooltip);
    return {
      dataIndex: dataIndex,
      width: width,
      title: /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("span", null, title), tooltipProps && /*#__PURE__*/_react.default.createElement(_tooltip.default, Object.assign({
        placement: 'top'
