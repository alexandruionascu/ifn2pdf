...
var TableList = function TableList(props) {
  ...
  var columns = Object.keys(columnSchema).map(function (dataIndex) {
    ...
    return {
      dataIndex: dataIndex,
      width: width,
      title: /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("span", null, title), tooltipProps && /*#__PURE__*/React.createElement(_Tooltip, Object.assign({
        placement: 'top'
